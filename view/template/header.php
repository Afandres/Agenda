...
<body class="hold-transition light-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
  <div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
      <img class="animation__wobble" src="../view/images/AJ.png" alt="AdminLTELogo" height="400" width="400">
    </div>
    <!-- Navbar -->
    <nav class="main-header navbar navbar-expand navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="#" class="nav-link">Agendamiento</a>
        </li>
      </ul>
      <!-- Right navbar links -->
      ...
      <div class="dropdown">
        <button class="btn btn-white dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <img id="img_nav" style="width: 28px;" class="img-circle elevation-2" src="../view/images/AJ.png "<?php echo $_SESSION['imagen']; ?>>
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
          <li class="user-header">
            <div class="image">
              <center>
              <img src="../view/images/AJ.png" <?php echo $_SESSION['imagen']; ?> class="img-circle elevation-2" alt="User Image" style="height:100px; width:100px;">
              </center>
            </div>
            <div class="text-center">
              <strong><a href="#" class="linkuser"><?php echo $_SESSION['nombre']; ?></a></strong>
            </div>
          </li>
          <li class="user-footer">
            <a href="../controller/usuario.php?op=salir" class="linkuser">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="#" class="brand-link">
        <img src="../view/images/AJ.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="linkuser">ANDRESJAVI</span>
      </a>
      <!-- Sidebar -->
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img src="../view/images/AJ.png" <?php echo $_SESSION['imagen']; ?> class="img-circle elevation-2" alt="User Image">
          </div>
          <div class="info">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            if ($_SESSION['escritorio'] == 1) {
              echo '<li class="nav-item">
                    <a href="../view/escritorio.php" class="nav-link ">
...
<?php
            if ($_SESSION['compras'] == 1) {
              echo '<li class="nav-item">
                    <a href="../view/compras.php" class="nav-link ">
                    <i class="nav-icon fas fa-columns"></i>
                      <p>
                        Listado 
                      </p>
...
<?php
            if ($_SESSION['rrhh'] == 1) {
              echo '<li class="nav-item">
                    <a href="../view/rrhh.php" class="nav-link ">
                    <i class="nav-icon fas fa-columns"></i>
                      <p>
                        Consultar 
                      </p>
